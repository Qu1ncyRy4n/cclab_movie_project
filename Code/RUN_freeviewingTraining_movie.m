...
try
    ...
    Results = table( ...
        'Size',[0 14], ...
        'VariableTypes',{'double','string','double','double','string','string', 'cell', 'double','double','double','double','double','double','string'}, ...
        'VariableNames',{'TrialNum','TrialType','TrialSuccess','RewardSize','ImageShown','MovieCategory','ImageRect' ...
        'TrialStart','FixStart','FixEnd','ImageOn','DotOff','MovieOff','AbortPhase'});
        ...
        switch state
            ...
            case "Hold_fix"
                ...
                elseif (GetSecs - trial_start_time_hold) >= t_holdfix
                    ...
                    trialInfo.MovieCategory = selectedFiles(idx).category;
